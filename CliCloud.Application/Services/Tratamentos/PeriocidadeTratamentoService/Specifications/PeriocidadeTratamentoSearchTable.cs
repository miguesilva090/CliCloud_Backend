...
{
    public class PeriocidadeTratamentoSearchTable : Specification<PeriocidadeTratamento>
    {
        public PeriocidadeTratamentoSearchTable(List<TableFilter> filters, string? dynamicOrder = "")
        {
