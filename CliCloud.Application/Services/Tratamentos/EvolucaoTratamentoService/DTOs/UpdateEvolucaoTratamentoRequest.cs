...
{
    public class UpdateEvolucaoTratamentoRequest : IDto
    {
    ...
    public class UpdateEvolucaoTratamentoValidator : AbstractValidator<UpdateEvolucaoTratamentoRequest>
    {
        public UpdateEvolucaoTratamentoValidator()
        {
