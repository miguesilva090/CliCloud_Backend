...
{
  public class UpdateServicoSessaoRequest : IDto
  {
  ...
  public class UpdateServicoSessaoValidator : AbstractValidator<UpdateServicoSessaoRequest>
  {
    public UpdateServicoSessaoValidator()
    {
