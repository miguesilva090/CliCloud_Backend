...
{
    public class MotivosDesmarcacaoSearchTable : Specification<MotivosDesmarcacao>
    {
        public MotivosDesmarcacaoSearchTable(List<TableFilter> filters, string? dynamicOrder = "")
        {
