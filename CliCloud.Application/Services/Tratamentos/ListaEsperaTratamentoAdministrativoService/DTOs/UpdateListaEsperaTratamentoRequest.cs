...
public class UpdateListaEsperaTratamentoRequest : IDto
{
...
public class UpdateListaEsperaTratamentoValidator : AbstractValidator<UpdateListaEsperaTratamentoRequest>
{
    public UpdateListaEsperaTratamentoValidator()
    {
