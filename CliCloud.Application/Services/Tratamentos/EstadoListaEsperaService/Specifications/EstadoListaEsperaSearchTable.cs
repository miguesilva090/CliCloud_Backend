...
{
    public class EstadoListaEsperaSearchTable : Specification<EstadoListaEspera>
    {
        public EstadoListaEsperaSearchTable(List<TableFilter> filters, string? dynamicOrder = "")
        {
