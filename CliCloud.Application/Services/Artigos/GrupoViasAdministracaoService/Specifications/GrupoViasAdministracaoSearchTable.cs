...
{
    public class GrupoViasAdministracaoSearchTable : Specification<GrupoViasAdministracao>
    {
        public GrupoViasAdministracaoSearchTable(List<TableFilter> filters, string? dynamicOrder = "")
        {
