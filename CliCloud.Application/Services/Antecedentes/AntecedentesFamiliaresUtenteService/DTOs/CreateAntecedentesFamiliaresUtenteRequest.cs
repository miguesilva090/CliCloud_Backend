...
{
    public class CreateAntecedentesFamiliaresUtenteRequest : IDto
    {
    ...
    public class CreateAntecedentesFamiliaresUtenteValidator : AbstractValidator<CreateAntecedentesFamiliaresUtenteRequest>
    {
        public CreateAntecedentesFamiliaresUtenteValidator()
        {
