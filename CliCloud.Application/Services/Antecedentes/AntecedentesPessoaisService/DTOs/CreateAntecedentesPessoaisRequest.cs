...
{
    public class CreateAntecedentesPessoaisRequest : IDto
    {
    ...
    public class CreateAntecedentesPessoaisValidator : AbstractValidator<CreateAntecedentesPessoaisRequest>
    {
        public CreateAntecedentesPessoaisValidator()
        {
