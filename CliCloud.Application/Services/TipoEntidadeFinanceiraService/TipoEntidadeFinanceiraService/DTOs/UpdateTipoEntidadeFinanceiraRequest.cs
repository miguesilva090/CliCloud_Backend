...
{
    public class UpdateTipoEntidadeFinanceiraRequest : IDto
    {
    ...
    public class UpdateTipoEntidadeFinanceiraValidator : AbstractValidator<UpdateTipoEntidadeFinanceiraRequest>
    {
        public UpdateTipoEntidadeFinanceiraValidator()
        {
            _ = RuleFor(x => x.Sigla)
                .NotEmpty()
                .MaximumLength(20)
