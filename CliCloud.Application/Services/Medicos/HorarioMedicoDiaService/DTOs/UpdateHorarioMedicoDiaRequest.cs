...
{
    public class UpdateHorarioMedicoDiaRequest : IDto
    {
    ...
    public class UpdateHorarioMedicoDiaValidator : AbstractValidator<UpdateHorarioMedicoDiaRequest>
    {
        public UpdateHorarioMedicoDiaValidator()
        {
