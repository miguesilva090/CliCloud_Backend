...
{
    public class CreateMargemMedicoRequest : IDto
    {
    ...
    public class CreateMargemMedicoValidator : AbstractValidator<CreateMargemMedicoRequest>
    {
        public CreateMargemMedicoValidator()
        {
