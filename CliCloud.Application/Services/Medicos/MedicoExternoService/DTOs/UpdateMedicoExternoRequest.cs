...
{
    public class UpdateMedicoExternoRequest : IDto
    {
    ...
    public class UpdateMedicoExternoValidator : AbstractValidator<UpdateMedicoExternoRequest>
    {
        public UpdateMedicoExternoValidator()
        {
