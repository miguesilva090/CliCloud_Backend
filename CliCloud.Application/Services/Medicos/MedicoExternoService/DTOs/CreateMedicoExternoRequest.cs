...
{
    public class CreateMedicoExternoRequest : IDto
    {
    ...
    public class CreateMedicoExternoValidator : AbstractValidator<CreateMedicoExternoRequest>
    {
        public CreateMedicoExternoValidator()
        {
