...
{
    public class UpdateEntidadePessoaRequest : IDto
    {
    ...
    public class UpdateEntidadePessoaValidator : AbstractValidator<UpdateEntidadePessoaRequest>
    {
        public UpdateEntidadePessoaValidator()
        {
