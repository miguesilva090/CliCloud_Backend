...
public class ZonaComercialSearchTable : Specification<ZonaComercialEntity>
{
    public ZonaComercialSearchTable(ZonaComercialTableFilter filter, Guid clinicaId, string? dynamicOrder = "")
    {
