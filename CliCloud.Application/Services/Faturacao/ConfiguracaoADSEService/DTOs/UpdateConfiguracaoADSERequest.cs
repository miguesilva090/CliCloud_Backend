...
{
  public class UpdateConfiguracaoADSERequest : IDto
  {
  ...
  public class UpdateConfiguracaoADSEValidator : AbstractValidator<UpdateConfiguracaoADSERequest>
  {
    public UpdateConfiguracaoADSEValidator()
    {
