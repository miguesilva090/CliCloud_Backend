...
{
    public class ProvenienciaUtenteSearchTable : Specification<ProvenienciaUtente>
    {
        public ProvenienciaUtenteSearchTable(List<TableFilter> filters, string? dynamicOrder = "")
        {
