...
{
    public class CreateTecnicoRequest : IDto
    {
        ...
        /// <summary>1=Fisioterapeuta, 2=Auxiliar, 3=Outro. Default Fisioterapeuta.</summary>
        public int TipoTecnico { get; set; } = (int)CliCloud.Domain.Enums.TipoTecnico.Fisioterapeuta;
    }

    public class CreateTecnicoValidator : AbstractValidator<CreateTecnicoRequest>
    {
        public CreateTecnicoValidator()
        {
