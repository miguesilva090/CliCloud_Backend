...
{
    public class CreateHorarioTecnicoRequest : IDto
    {
        ...
        // public IEnumerable<CreateHorarioTecnicoDiaRequest>? Horarios { get; set; }
    }

    public class CreateHorarioTecnicoValidator : AbstractValidator<CreateHorarioTecnicoRequest>
    {
        public CreateHorarioTecnicoValidator()
        {
