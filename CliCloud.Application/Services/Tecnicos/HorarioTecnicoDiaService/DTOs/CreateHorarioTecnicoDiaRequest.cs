...
{
    public class CreateHorarioTecnicoDiaRequest : IDto
    {
    ...
    public class CreateHorarioTecnicoDiaValidator : AbstractValidator<CreateHorarioTecnicoDiaRequest>
    {
        public CreateHorarioTecnicoDiaValidator()
        {
