...
{
    public class UpdateCentroSaudeRequest : IDto
    {
    ...
    public class UpdateCentroSaudeValidator : AbstractValidator<UpdateCentroSaudeRequest>
    {
        public UpdateCentroSaudeValidator()
        {
            ...
            _ = RuleForEach(x => x.EntidadeContactos).SetValidator(new UpsertEntidadeContactoItemValidator()).When(x => x.EntidadeContactos != null && x.EntidadeContactos.Any());
        }
    }
}
