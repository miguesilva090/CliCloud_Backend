...
{
    public class UpdateContaBancariaRequest : IDto
    {
    ...
    public class UpdateContaBancariaValidator : AbstractValidator<UpdateContaBancariaRequest>
    {
        public UpdateContaBancariaValidator()
        {
