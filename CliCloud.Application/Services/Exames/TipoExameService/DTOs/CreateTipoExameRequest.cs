...
{
    public class CreateGrupoAnaliseLinhaRequest
    {
    ...
    public class CreateTipoExameRequest : IDto
    {
        ...
        public List<CreateGrupoAnaliseLinhaRequest> GrupoAnaliseLinhas { get; set; } = [];
    }
}
