...
{
  public class CreateServicoConsultaRequest : IDto
  {
  ...
  public class CreateServicoConsultaValidator : AbstractValidator<CreateServicoConsultaRequest>
  {
    public CreateServicoConsultaValidator()
    {
