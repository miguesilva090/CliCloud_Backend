...
public sealed class ConsultasDoDiaAdmissoesSpec : Specification<Admissao>
{
  public ConsultasDoDiaAdmissoesSpec(DateTime data, Guid? medicoId, bool desmarcadas)
  {
    ...
    _ = Query.OrderBy(x => x.HoraInicio).ThenBy(x => x.Ordem);
  }
}
