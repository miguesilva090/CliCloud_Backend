...
{
  public class UpdateReceitaLinhaRequest
  {
  ...
  public class UpdateReceitaMedicaRequest : IDto
  {
    ...
    public List<UpdateReceitaLinhaRequest> Linhas { get; set; } = [];
  }

  public class UpdateReceitaMedicaValidator : AbstractValidator<UpdateReceitaMedicaRequest>
  {
    public UpdateReceitaMedicaValidator()
    {
