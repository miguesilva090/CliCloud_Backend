...
{
    public class UpdateHabitosEViciosRequest : IDto
    {
    ...
    public class UpdateHabitosEViciosValidator : AbstractValidator<UpdateHabitosEViciosRequest>
    {
        public UpdateHabitosEViciosValidator()
        {
            // Por agora não há regras obrigatórias específicas além do UtenteId que vem da rota.
        }
    }
}
