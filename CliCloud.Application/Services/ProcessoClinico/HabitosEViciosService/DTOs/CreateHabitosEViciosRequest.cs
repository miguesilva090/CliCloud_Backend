...
{
    public class CreateHabitosEViciosRequest : IDto
    {
    ...
    public class CreateHabitosEViciosValidator : AbstractValidator<CreateHabitosEViciosRequest>
    {
        public CreateHabitosEViciosValidator()
        {
