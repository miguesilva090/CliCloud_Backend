...
{
    public class TemperaturaCorporalSearchTable : Specification<TemperaturaCorporal>
    {
        public TemperaturaCorporalSearchTable(List<TableFilter> filters, string? dynamicOrder = "")
        {
