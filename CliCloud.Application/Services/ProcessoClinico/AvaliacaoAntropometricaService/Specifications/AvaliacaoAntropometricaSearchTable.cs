...
{
    public class AvaliacaoAntropometricaSearchTable : Specification<AvaliacaoAntropometrica>
    {
        public AvaliacaoAntropometricaSearchTable(List<TableFilter> filters, string? dynamicOrder = "")
        {
