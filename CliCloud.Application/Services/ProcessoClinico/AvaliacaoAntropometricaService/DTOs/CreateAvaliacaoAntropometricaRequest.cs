...
{
    public class CreateAvaliacaoAntropometricaRequest : IDto
    {
    ...
    public class CreateAvaliacaoAntropometricaValidator : AbstractValidator<CreateAvaliacaoAntropometricaRequest>
    {
        public CreateAvaliacaoAntropometricaValidator()
        {
