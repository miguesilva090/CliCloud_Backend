...
{
    public class UpdateOdontogramaDefinitivoRequest : IDto
    {
    ...
    public class UpdateOdontogramaDefinitivoValidator : AbstractValidator<UpdateOdontogramaDefinitivoRequest>
    {
        public UpdateOdontogramaDefinitivoValidator()
        {
