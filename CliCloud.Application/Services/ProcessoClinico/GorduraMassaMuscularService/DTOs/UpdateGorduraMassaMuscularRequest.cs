...
{
    public class UpdateGorduraMassaMuscularRequest : IDto
    {
    ...
    public class UpdateGorduraMassaMuscularValidator : AbstractValidator<UpdateGorduraMassaMuscularRequest>
    {
        public UpdateGorduraMassaMuscularValidator()
        {
