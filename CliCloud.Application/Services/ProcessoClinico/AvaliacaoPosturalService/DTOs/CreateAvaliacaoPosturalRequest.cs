...
{
    public class CreateAvaliacaoPosturalRequest : IDto
    {
    ...
    public class CreateAvaliacaoPosturalValidator : AbstractValidator<CreateAvaliacaoPosturalRequest>
    {
        public CreateAvaliacaoPosturalValidator()
        {
