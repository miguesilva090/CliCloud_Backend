...
{
    public class AvaliacaoPosturalSearchTable : Specification<AvaliacaoPostural>
    {
        public AvaliacaoPosturalSearchTable(List<TableFilter> filters, string? dynamicOrder = "")
        {
