...
{
    public class IndiceMassaCorporalSearchTable : Specification<IndiceMassaCorporal>
    {
        public IndiceMassaCorporalSearchTable(List<TableFilter> filters, string? dynamicOrder = "")
        {
