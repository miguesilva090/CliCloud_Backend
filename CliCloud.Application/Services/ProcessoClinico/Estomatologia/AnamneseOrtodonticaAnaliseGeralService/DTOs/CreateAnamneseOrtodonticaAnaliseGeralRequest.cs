...
{
    public class CreateAnamneseOrtodonticaAnaliseGeralRequest : IDto
    {
    ...
    public class CreateAnamneseOrtodonticaAnaliseGeralValidator : AbstractValidator<CreateAnamneseOrtodonticaAnaliseGeralRequest>
    {
        public CreateAnamneseOrtodonticaAnaliseGeralValidator()
        {
