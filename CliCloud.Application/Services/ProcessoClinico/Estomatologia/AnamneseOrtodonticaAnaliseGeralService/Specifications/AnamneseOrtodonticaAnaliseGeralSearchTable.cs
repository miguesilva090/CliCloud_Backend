...
{
    public class AnamneseOrtodonticaAnaliseGeralSearchTable : Specification<AnamneseOrtodonticaAnaliseGeral>
    {
        public AnamneseOrtodonticaAnaliseGeralSearchTable(Guid? utenteId, string? keyword, string? dynamicOrder = "")
        {
