...
{
    public class AnamneseOrtodonticaAnaliseGeralSearchList : Specification<AnamneseOrtodonticaAnaliseGeral>
    {
        public AnamneseOrtodonticaAnaliseGeralSearchList(string? keyword = "")
        {
