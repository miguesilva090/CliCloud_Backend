...
{
    public class CreateAnamneseOrtodonticaAnaliseFuncionalRequest : IDto
    {
    ...
    public class CreateAnamneseOrtodonticaAnaliseFuncionalValidator : AbstractValidator<CreateAnamneseOrtodonticaAnaliseFuncionalRequest>
    {
        public CreateAnamneseOrtodonticaAnaliseFuncionalValidator()
        {
