...
{
    public class AnamneseOrtodonticaAnaliseFuncionalSearchList : Specification<AnamneseOrtodonticaAnaliseFuncional>
    {
        public AnamneseOrtodonticaAnaliseFuncionalSearchList(string? keyword = "")
        {
