...
{
    public class AnamneseOdontopediatriaSearchTable : Specification<AnamneseOdontopediatria>
    {
        public AnamneseOdontopediatriaSearchTable(Guid? utenteId, string? keyword, string? dynamicOrder = "")
        {
