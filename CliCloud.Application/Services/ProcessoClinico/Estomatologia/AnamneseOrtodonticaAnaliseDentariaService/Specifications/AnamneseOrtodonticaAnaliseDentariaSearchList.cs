...
{
    public class AnamneseOrtodonticaAnaliseDentariaSearchList : Specification<AnamneseOrtodonticaAnaliseDentaria>
    {
        public AnamneseOrtodonticaAnaliseDentariaSearchList(string? keyword = "")
        {
