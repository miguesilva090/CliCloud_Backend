...
{
    public class CreateAnamneseOrtodonticaAnaliseDentariaRequest : IDto
    {
    ...
    public class CreateAnamneseOrtodonticaAnaliseDentariaValidator : AbstractValidator<CreateAnamneseOrtodonticaAnaliseDentariaRequest>
    {
        public CreateAnamneseOrtodonticaAnaliseDentariaValidator()
        {
