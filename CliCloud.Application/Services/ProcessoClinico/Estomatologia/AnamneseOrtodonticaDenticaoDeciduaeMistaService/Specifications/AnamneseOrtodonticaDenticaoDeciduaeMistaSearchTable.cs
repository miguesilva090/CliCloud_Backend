...
{
    public class AnamneseOrtodonticaDenticaoDeciduaeMistaSearchTable : Specification<AnamneseOrtodonticaDenticaoDeciduaeMista>
    {
        public AnamneseOrtodonticaDenticaoDeciduaeMistaSearchTable(Guid? utenteId, string? keyword, string? dynamicOrder = "")
        {
