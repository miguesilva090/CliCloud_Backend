...
{
    public class CreateAnamneseOrtodonticaATMRequest : IDto
    {
    ...
    public class CreateAnamneseOrtodonticaATMValidator : AbstractValidator<CreateAnamneseOrtodonticaATMRequest>
    {
        public CreateAnamneseOrtodonticaATMValidator()
        {
