...
{
    public class UpdateAnamneseOrtodonticaATMRequest : IDto
    {
    ...
    public class UpdateAnamneseOrtodonticaATMValidator : AbstractValidator<UpdateAnamneseOrtodonticaATMRequest>
    {
        public UpdateAnamneseOrtodonticaATMValidator()
        {
