...
{
    public class AnamneseOrtodonticaATMSearchTable : Specification<AnamneseOrtodonticaATM>
    {
        public AnamneseOrtodonticaATMSearchTable(Guid? utenteId, string? keyword, string? dynamicOrder = "")
        {
