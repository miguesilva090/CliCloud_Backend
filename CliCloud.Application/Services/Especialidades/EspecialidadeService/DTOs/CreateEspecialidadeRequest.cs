...
{
    public class CreateEspecialidadeRequest : IDto
    {
    ...
    public class CreateEspecialidadeValidator : AbstractValidator<CreateEspecialidadeRequest>
    {
        public CreateEspecialidadeValidator()
        {
            _ = RuleFor(x => x.Nome)
                .NotEmpty()
                .MaximumLength(30)
