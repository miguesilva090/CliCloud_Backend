...
{
  public class UpdateSubsistemaServicoRequest : IDto
  {
  ...
  public class UpdateSubsistemaServicoValidator : AbstractValidator<UpdateSubsistemaServicoRequest>
  {
    public UpdateSubsistemaServicoValidator()
    {
