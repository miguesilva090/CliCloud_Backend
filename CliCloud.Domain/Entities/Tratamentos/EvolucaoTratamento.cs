...
{
    [Table("EvolucaoTratamento", Schema = "Tratamentos")]
    public class EvolucaoTratamento : AuditableEntityWithSoftDelete
    {
        ...
        public ICollection<EvolucaoTratamentoFicheiro> Ficheiros { get; set; } = [];
    }
}